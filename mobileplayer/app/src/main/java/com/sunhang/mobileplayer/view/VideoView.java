package com.sunhang.mobileplayer.view;
...
//            }
    ...
    public void fullscreenToggle() {
    	...
    	if (isFullscreen) {
    		...
    		params.height = defaultHheight;
		} else {
			// 设置为全屏
			params.width = Utils.getScreenWidth(mContext);
    		params.height = Utils.getScreenHeight(mContext);
		}
    	
    	requestLayout();	// 通知View去更新布局参数
